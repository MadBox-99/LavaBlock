...
require("prototypes.recipes.air.air-compressor")
require("prototypes.recipes.air.extraction.extraction-from-air")
require("prototypes.recipes.lava-cooling-with-liquid-nitrogen")
require("prototypes.recipes.lava-science-pack")
